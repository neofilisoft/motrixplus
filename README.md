...
- **Right-click integration** - "Download with Motrix+" on any link
- **Native notifications** - alerts on completion and errors
- **Full settings page** - speed limits, connection counts, user-agent, and more
...
## License
Read [Motrix](https://github.com/agalwood/Motrix/blob/master/LICENSE) [aria2](https://github.com/aria2/aria2?tab=License-2-ov-file)
